...
class TestPipelinedEncoderIntegration:
    ...
    def golden_sample(self) -> tuple[list[str], npt.NDArray[np.float16]]:
    ...
    def test_bulk_encode(
        ...
        encoder = PipelinedEncoder(
            lambda: get_model("sentence-transformers/all-MiniLM-L6-v2", False, False)
        )
        ...
        np.testing.assert_allclose(embeddings, expect_embeddings, rtol=1e-3, atol=1e-3)
